...
describe("verifyCliContract", () => {
  it("passes when the declared resume + session-id shapes appear in --help", async () => {
  ...
  it("passes Codex when `resume` subcommand appears in --help (no session-id declared)", async () => {
